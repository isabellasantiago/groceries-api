            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        _d.label = 2;
                    case 2: return [4, productsLine_1.next()];
                    case 3:
                        if (!(productsLine_1_1 = _d.sent(), !productsLine_1_1.done))
                            return [3, 5];
                    ...
                    case 7:
                        ...
                        if (!(productsLine_1_1 && !productsLine_1_1.done && (_a = productsLine_1["return"])))
                            return [3, 9];
                        return [4, _a.call(productsLine_1)];
                    case 8:
                        _d.sent();
                        _d.label = 9;
                    case 9: return [3, 11];
                    ...
                    case 12:
                        ...
                        _d.label = 13;
                    case 13: return [4, products_1.next()];
                    case 14:
                        if (!(products_1_1 = _d.sent(), !products_1_1.done))
                            return [3, 18];
                        ...
                        return [4, client_1.client.products.findFirst({
                    ...
                    case 15:
                        ...
                        if (!!productExists)
                            return [3, 17];
                        return [4, client_1.client.products.create({
                                data: {
                                    code_bar: code_bar,
                    ...
                    case 20:
                        ...
                        if (!(products_1_1 && !products_1_1.done && (_b = products_1["return"])))
                            return [3, 22];
                        return [4, _b.call(products_1)];
                    case 21:
                        _d.sent();
                        _d.label = 22;
                    case 22: return [3, 24];
                    case 23:
                        ...
                        return [7];
                    case 24: return [7];
                    case 25: return [2, response.json(products)];
                    case 26:
                        error_1 = _d.sent();
                        return [2, response.json({ error: error_1 })];
                    case 27: return [2];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, client_1.client.products.findMany({
                                where: {
                                    description: {
                    ...
                    case 1:
                        products = _a.sent();
                        return [2, response.json(products)];
                    case 2:
                        error_2 = _a.sent();
